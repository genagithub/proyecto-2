...
app.layout = html.Div(id="body", className="e2_body", children=[
    html.A(href="https://github.com/genagithub/proyecto-2/blob/main/redirección_del_presupuesto_publicitario.ipynb", children=[html.H1("Estrategia de Inversión: del volumen a la rentabilidad", className="e2_title")]),
