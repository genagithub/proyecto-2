...
app.layout = html.Div(id="body", className="e2_body", children=[
    html.A(href="https://github.com/genagithub/proyecto-2/blob/main/redirección_del_presupuesto_para_maximizar_ROI.ipynb", children=[html.H1("Estrategia de Inversión: del volumen a la rentabilidad", className="e2_title")]),
    ...
    html.Div(className="e2_div_stats", children=[
        ...
        html.Div([html.H3("Elasticidad TV (dominancia): "), html.B(f"{round(elasticities["TV"], 2)}",style={"font-weight":"bold","font-size":"1.2em"})], className="e2_stats"),
        html.Div([html.H3("Elasticidad Radio (oportunidad): "), html.B(f"{round(elasticities["Radio"], 2)}",style={"font-weight":"bold","font-size":"1.2em"})], className="e2_stats"),
    ]),
    ...
    html.Div(id="dashboard", className="e2_dashboard", children=[
        html.Div(className="e2_column_1", children=[
            ...
            html.Div(className="e2_div_slider", children=[
                ...
                dcc.Slider(id="rebalance-slider", 
